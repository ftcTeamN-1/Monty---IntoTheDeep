...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 12.2952; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -2.75; // in; offset of the lateral wheel

    //Todo: New code
    public static double X_MULTIPLIER = 1.0069;
    public static double Y_MULTIPLIER = 1.0045;
